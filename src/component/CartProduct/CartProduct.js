          ...
          if (cartItemAttribute.id === itemAttribute.id) {
            return itemAttribute.items.map((itemAttributeSelection, key) => {
              if (cartItemAttribute.type === "text") {
                return (
                  <div
                    className="Product-Info-Attributes-Attribute"
                    key={itemAttributeSelection.id}
                  >
                    <div className="Product-Info-Attributes-Attr-Text">
                      <button
                        className={
                          cartItemAttribute.selected === key
                            ? "Product-Info-Attributes-Attr-Text-Option-Selected"
                            : "Product-Info-Attributes-Attr-Text-Option"
                        }
                        key={key}
                      >
                        <p className="Product-Info-Attributes-Attr-Text-Option-Text">
              ...
              if (cartItemAttribute.type === "swatch") {
                return (
                  <div
                    className="Product-Info-Attributes-Attr"
                    key={itemAttributeSelection.id}
                  >
                    <div className="Product-Info-Attributes-Attr-AttrSwatch">
                      <div
                        className="Product-Info-Attributes-Attr-AttrSwatch-Option"
                        key={key}
                      >
                        <button
                          className={
                            cartItemAttribute.selected === key
                              ? "Product-Info-Attributes-Attr-AttrSwatch-Option-Color-Selected"
                              : "Product-Info-Attributes-Attr-AttrSwatch-Option-Color"
                          }
                          style={{
                          ...
                          key={key}
                        />
                        <p className="Product-Info-Attributes-Attr-AttrSwatch-Option-Text">
